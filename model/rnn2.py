...
#===================================
from model import rnn_cell2 as rnn_cell
...
def rnn(cell, inputs, initial_state=None, dtype=None,
        sequence_length=None, scope=None, q=None, W_att= None):
  ...
  with vs.variable_scope(scope or "RNN") as varscope:
    ...
    for time, input_ in enumerate(inputs):
      ...
      #===========================================
      call_cell = lambda: cell(input_, state, q=q, W_att=W_att)
...
def bidirectional_rnn(cell_fw, cell_bw, inputs,
                      ...
                      dtype=None, sequence_length=None, scope=None, q=None, W_att=None):
  ...
  with vs.variable_scope(name + "_FW") as fw_scope:
    output_fw, output_state_fw = rnn(cell_fw, inputs, initial_state_fw, dtype,
                                     sequence_length, scope=fw_scope, q=q, W_att=W_att)
